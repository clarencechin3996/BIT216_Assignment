    ...
    <div id="main">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item" style="margin-left: 20px;">
                <a class="nav-link active" href="recordVaccineData.php">New Vaccine Information</a>
              </li>
            </ul>
      ...
      <div id="site_content">
        <div id="content">
          ...
          <form action="save_vaccine_data.php" method="POST">
            <h1>New Vaccine Information</h1>
            <div class="form-row">
              <div class="col-lg-7">
                <label for="test">Manufacturer:</label>
                <input type="text" placeholder="Manufacturer" name="manufacturer" required class="form-control my-2 p-3">
              </div>
            </div>
            <div class="form-row">
              <div class="col-lg-7">
                <label for="test">Vaccine Name:</label>
                <input type="text" placeholder="Vaccine Name" name="vaccine_name" required class="form-control my-2 p-3">
              </div>
            </div>
            <div class="form-row">
              <div class="col-lg-7">
                <button type="submit" class="btn2 mt-3 mb-5">Record New Vaccine Data</button>
              </div>
            </div>
          </form>
        </div>
